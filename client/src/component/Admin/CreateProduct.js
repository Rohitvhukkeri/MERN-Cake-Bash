...
function CreateProduct() {
  ...
  return (
    <Container sx={{ paddingTop: "20px" }}>
      <Typography variant="h4" align="center" sx={{ paddingTop: 1}}>
        Add New Product
      </Typography>
          ...
          <Card elevation={8}>
            ...
            <CardActions>
              {loading ? (
                ...
                <Box>
                  <img src={image ? image.url : ""} alt="" height='300vh' width='500px' />
            ...
            <CardContent>
              <Box component={"form"} onSubmit={submitHandler}>
                ...
                <TextField
                  ...
                  sx={{ marginTop: 2 }}
                />
                <Button color='success' variant="contained" type="submit" sx={{ marginTop: 2 }}>
                  Create
                </Button>
              </Box>
            </CardContent>
